...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="../STREAM_SPECIFIC/journal/journal_introduction.xsl"/>
    <xsl:include href="../STREAM_SPECIFIC/journal/journal_jrnlbody_ChOf_jrnldoc.xsl"/>    
    <xsl:include href="../STREAM_SPECIFIC/journal/journal_jrnlinfo_ChOf_jrnlbody.xsl"/>    
    <xsl:include href="../STREAM_SPECIFIC/journal/journal_jrnlbodytext_ChOf_jrnlbody.xsl"/>
