...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="../STREAM_SPECIFIC/cases/cases_introduction.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.body_ChOf_casedoc.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.headnote_ChOf_case.body.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.info_ChOf_case.headnote.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.courtinfo_ChOf_case.info-and-case.judgement.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/catchwordgrp_ChOf_case.headnote.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.factsummary_ChOf_case.headnote.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.decisionsummary_ChOf_case.headnote.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.decisionsummary_glp.note_to_note.xsl"/>

    <xsl:include
        href="../STREAM_SPECIFIC/cases/case.decisionsummary_case.consideredcases-to-case.references.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.priorhist_ChOf_case.headnote.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.content_ChOf_case.body.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.judgements_ChOf_case.content.xsl"/>

    <xsl:include
        href="../STREAM_SPECIFIC/cases/case.constituents_case.constituent-to-case.constituent.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.judgement_ChOf_case.judgements.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.appendix_ChOf_case.content.xsl"/>

    <xsl:include href="../STREAM_SPECIFIC/cases/case.author_ChOf_case.content.xsl"/>
