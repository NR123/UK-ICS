...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:/C:/xspec/tutorial/escape-for-regex.xslt"/>
   <xsl:import href="file:/C:/xspec/src/compiler/generate-tests-utils.xsl"/>
   <xsl:import href="file:/C:/xspec/src/schematron/sch-location-compare.xsl"/>
   <xsl:namespace-alias stylesheet-prefix="__x" result-prefix="xsl"/>
   <xsl:variable name="x:stylesheet-uri"
                 as="xs:string"
                 select="'file:/C:/xspec/tutorial/escape-for-regex.xslt'"/>
   ...
   <xsl:template name="x:main">
      ...
      <xsl:result-document format="x:report">
         <xsl:processing-instruction name="xml-stylesheet">type="text/xsl" href="file:/C:/xspec/src/compiler/format-xspec-report.xsl"</xsl:processing-instruction>
