...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="glp:note">
        <xsl:choose>
            ...
            And wherever footnotegrp is Parent of glp:note then removing the glp:note as per the discussion with Amita as it is creating validation errors/text drops in rocket-->
